        ...
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6">
            <div>
              ...
              <p className="font-medium">{userData?.name || 'Nome não disponível'}</p>
            </div>
            <div>
              <p className="text-gray-500 text-sm mb-1">CPF</p>
              <p className="font-medium">{userData?.cpf || 'CPF não disponível'}</p>
            </div>
            <div>
          ...
          <div className="bg-govbr-yellow p-4 rounded-md border border-yellow-300 mb-6">
            <p className="flex mb-2">
              ...
              <span className="font-medium text-justify sm:text-left">Atenção: O não pagamento até a data de vencimento resultará em:</span>
            </p>
